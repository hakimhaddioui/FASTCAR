<div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="bx bx-plus me-2"></i>Nouveau Contrat de Location</h3>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="cin_client" class="form-select" required>
                            ...
                            <?php foreach ($clients as $client): ?>
                                <option value="<?= $client->cin ?>" <?= ($_POST['cin_client'] ?? '') === $client->cin ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                        ...
                        <select name="matricule_vehicule" class="form-select" required id="vehiculeSelect">
                            ...
                            <?php foreach ($voitures as $voiture): ?>
                                <option value="<?= $voiture->matricule ?>" data-prix="<?= $voiture->prixJournalier ?>" 
                                    <?= ($_POST['matricule_vehicule'] ?? '') === $voiture->matricule ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="kilometrage_location" class="form-control" 
                               value="<?= htmlspecialchars($_POST['kilometrage_location'] ?? '') ?>" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="etat_vehicule_location" class="form-control" 
                               ...
                               value="<?= htmlspecialchars($_POST['etat_vehicule_location'] ?? '') ?>" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="date_debut" class="form-control" 
                               value="<?= htmlspecialchars($_POST['date_debut'] ?? '') ?>" required id="dateDebut">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Date fin *</label>
                        <input type="date" name="date_fin" class="form-control" 
                               value="<?= htmlspecialchars($_POST['date_fin'] ?? '') ?>" required id="dateFin">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="mode_paiement" class="form-select" required>
                            <option value="Espèce" <?= ($_POST['mode_paiement'] ?? '') === 'Espèce' ? 'selected' : '' ?>>Espèce</option>
                            <option value="Carte" <?= ($_POST['mode_paiement'] ?? '') === 'Carte' ? 'selected' : '' ?>>Carte</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="montant_total" class="form-control" 
                               value="<?= htmlspecialchars($_POST['montant_total'] ?? '') ?>" required id="montantTotal" readonly>
                    </div>
                    <div class="mb-3">
                        ...
                        <select name="num_agent" class="form-select" required>
                            ...
                            <?php foreach ($agents as $agent): ?>
                                <option value="<?= $agent->numAgent ?>" <?= ($_POST['num_agent'] ?? '') === $agent->numAgent ? 'selected' : '' ?>>
